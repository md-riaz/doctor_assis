							...
							<?php else : ?>
								<?php foreach ($data['content'] as $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/" data-confirm="Are you sure you want to accept this doctor ?"
                                               class="btn btn-sm btn-primary"><span
                                                        data-feather="user-plus"></span> Accept</a>
                                            <a href="/" data-confirm="Are you sure you want to reject this doctor ?"
                                               class="btn btn-sm btn-danger"><span
                                                        data-feather="trash"></span> Reject</a>
                                        </td>
                                    </tr>
								<?php endforeach; ?>
							<?php endif; ?>
